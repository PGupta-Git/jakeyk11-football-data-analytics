...
def get_competition_logo(competition, year=None, logo_brighten=False):
    ...
    if competition in ["EPL", "Premier League", "GB1"]:
        url = (
            "https://static.sport.optus.com.au/images/competition/PL.png"
            if logo_brighten
            else "https://www.fifplay.com/img/public/premier-league-2-logo.png"
        )
    ...
    if competition in ["Serie A", "Serie_A", "Serie A TIM", "Lega Serie A", "IT1"]:
        url = (
            "https://1000logos.net/wp-content/uploads/2021/10/Italian-Serie-A-logo.png"
        )
...
def get_team_badge_and_colour(team, hoa="home"):
    ...
    if team in ["Unión Deportiva Almería", "UD Almeria", "U.D. Almeria", "Almeria"]:
        url = (
            "https://seeklogo.com/images/A/almeria-ud-logo-1AEACC1508-seeklogo.com.png"
        )
    ...
    if team in ["Bologna", "Bologna FC", "Bologna 1909", "Bologna FC 1909"]:
        url = (
            "https://1000logos.net/wp-content/uploads/2021/02/Bologna-logo-768x512.png"
        )
    ...
    if team in ["Burnley FC", "Burnley"]:
        url = (
            "https://1000logos.net/wp-content/uploads/2018/06/Burnley-logo-768x432.png"
        )
        cmap = cm.get_cmap("BuPu") if hoa == "home" else cm.get_cmap("Blues")
    ...
    if team in ["Forest Green", "Forest Green Rovers FC", "Forest Green Rovers"]:
        url = (
            "https://www.fgr.co.uk/static/fgr-logo-244366e93842f383f8a3b515ed76edc3.png"
        )
    ...
    if team in ["Reading", "Reading FC"]:
        url = (
            "https://seeklogo.com/images/R/reading-fc-logo-E95E21532B-seeklogo.com.png"
        )
        cmap = cm.get_cmap("Blues") if hoa == "home" else cm.get_cmap("Greys")
    ...
    if team in ["Real Sociedad", "Real Sociedad SAC", "Real Sociedad S.A.C"]:
        url = (
            "https://logos-world.net/wp-content/uploads/2020/11/Real-Sociedad-Logo.png"
        )
