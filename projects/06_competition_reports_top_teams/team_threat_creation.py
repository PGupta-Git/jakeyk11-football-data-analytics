...
threat_creating_events_df = threat_creating_events_df[
    ~threat_creating_events_df["satisfiedEventsTypes"].apply(
...
subtitle_text = (
    "Heatmaps showing Zones of <High Threat Creation> and <Low Threat Creation>"
)
