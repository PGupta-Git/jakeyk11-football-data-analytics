...
team_ball_win_height = sorted(
    team_ball_win_height.items(), key=lambda x: x[1], reverse=True
)
...
subtitle_text = (
    "Heatmaps showing Zones of <Frequent Ball Winning> and <Infrequent Ball Winning>"
)
